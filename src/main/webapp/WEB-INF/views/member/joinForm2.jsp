        ...
        <div class="example-box-wrapper">
            <form id="joinform" action="join" class="form-horizontal bordered-row" method="post" onsubmit="return formCheck();">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="custid" id="custid" class="form-control" maxlength="10" placeholder="Your ID" readonly="readonly"  />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" id="sample4_postcode" name="postcode" class="form-control popover-button-default" readonly="readonly" placeholder="Your Company Postcode">
                        <span class="input-group-btn">
