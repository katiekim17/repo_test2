...
<div id="page-wrapper"><div class="top-bar bg-topbar">
	...
	<!-- <div class="main-header bg-header wow fadeInDown"> -->
            ...
            <a href="login" title="EcoCoffee Main Template" class="btn btn-sm float-left btn-alt btn-hover mrg10R btn-default">
                <span>로그인</span>
...
<div class="main-header bg-header wow fadeInDown">
    <div class="container">
    <a href="index.html" class="header-logo" title="EcoCoffee - Create perfect RECYLCE Coffee"></a><!-- .header-logo -->
